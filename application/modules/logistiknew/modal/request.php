...
<!-- <div class="modal fade" id="modal_new_invoice" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/logistiknew/request/newinvoice" id="formnewinvoice">
                <div class="modal-body">
                    <div class="text-center mb-5">
                ...
                <div class="modal-footer p-1">				
                    <input class="btn btn-light-primary" id="modal_new_invoice_btn" type="submit" value="SUBMIT" name="simpan" >
                </div>
            </form>
        </div>
    </div>
...
<!-- <div class="modal fade" id="modal_upload_lampiran" tabindex="-1" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/logistiknew/request/notelampiran" id="formnotelampiran">
...
<!-- <div class="modal fade" id="modal_upload_invoice" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/logistiknew/request/noinvoice" id="formnoinvoice">
