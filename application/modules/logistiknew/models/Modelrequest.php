            ...
            $query =
                    "
                        select a.no_pemesanan, no_spu, no_pemesanan_unit, pettycash_id, judul_pemesanan, note, attachment, attachment_note, supplier_id, invoice, invoice_no, from_department_id, department_id, type, method methodid, status_vice, status_dir, status_com, subtotal, harga_ppn, total, cito, status,
                            ...
                            (select color       from dt01_gen_master_ms where active='1' and jenis_id='PO_2' and code=a.method)colorjenis,
                            (select master_name from dt01_gen_master_ms where active='1' and jenis_id='PO_2' and code=a.method)namejenis,
                            (select color       from dt01_gen_master_ms where active='1' and jenis_id='PO_3' and code=a.status)colorstatus,
                            (select master_name from dt01_gen_master_ms where active='1' and jenis_id='PO_3' and code=a.status)namestatus,
                            ...
                            (select supplier from dt01_lgu_supplier_ms where active=a.active and supplier_id=a.supplier_id)namasupplier,
