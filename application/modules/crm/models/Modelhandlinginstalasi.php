<?php
    class Modelhandlinginstalasi extends CI_Model{
            ...
            $query =
                    "
                        select a.trans_id, code, nama, no_identitas, no_hp, lantai, nama_petugas, saran, department_id, status, attachment, filename, filename_buktitl, answer_instalasi, bukti_tl, response,
                            ...
                            (select name  from dt01_gen_user_data where active='1' and user_id=(select user_id from dt01_gen_department_ms where active='1' and department_id=(select header_id from dt01_gen_department_ms where active='1' and department_id=a.department_id)))namapicmanager,
                            (select no_hp from dt01_gen_user_data where active='1' and user_id=(select user_id from dt01_gen_department_ms where active='1' and department_id=(select header_id from dt01_gen_department_ms where active='1' and department_id=a.department_id)))nohppicmanager,
