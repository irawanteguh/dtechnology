<?php
    class Modelrequest extends CI_Model{
        ...
        function datarequest($orgid,$status){
            $query =
                    "
                        select a.no_pemesanan, judul_pemesanan, note, invoice, method, cito, attachment_note, subtotal, harga_ppn, total, status, status_vice, status_dir, attachment, date_format(a.created_date, '%d.%m.%Y %H:%i:%s')tglbuat,
