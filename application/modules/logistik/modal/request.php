...
<div class="modal fade" id="modal-upload-lampiran" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/logistik/request/notelampiran" id="formlampiran">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-xl-12 mb-5">
                            <label class="d-flex align-items-center fs-5 fw-bold mb-2 required">Note :</label>
                            <textarea class="form-control form-control-solid" name="modal-upload-lampiran-note" id="modal-upload-lampiran-note"></textarea>
                        </div>
