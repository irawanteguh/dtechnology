...
<div class="d-flex flex-column flex-column-fluid">
    <div class="d-flex flex-column flex-column-fluid p-5 py-lg-2">
        <a href="#" class="mb-2 pt-lg-2 text-center" id="bookingButton">
            <img alt="Logo" src="<?php echo base_url();?>assets/images/logo/dtechnology.png" class="h-60px mb-5" />
            <img alt="Logo" src="<?php echo base_url();?>assets/images/clients/10c84edd-500b-49e3-93a5-a2c8cd2c8524.png" class="h-100px mb-5" />
            <img alt="Logo" src="<?php echo base_url();?>assets/images/clients/4169b311-3119-48e1-8d5c-e1924d52d7c6.png" class="h-100px mb-5" />
        </a>
        <div class="pt-lg-2 mb-10 text-center">
            <h4 class="fw-bolder fs-2qx text-gray-800 mb-7">RMB Hospital Group</h1>
            <div class="fw-bold fs-5 text-muted mb-15">
            ...
            <div class="text-center">
                <button class="btn btn-lg btn-primary fw-bolder" id="bookingNowjkn">Mobile JKN</button>
                <button class="btn btn-lg btn-info fw-bolder" id="bookingNownonjkn">NON JKN</button>
            </div>
        </div>

        <div id="stepperForm" style="display: none;">
...
<script>
    document.getElementById('bookingNownonjkn').addEventListener('click', function() {
        // document.querySelector('.pt-lg-2.mb-10').style.display = 'none';
        document.getElementById('bookingNownonjkn').style.display = 'none';
        document.getElementById('bookingNowjkn').style.display = 'none';
