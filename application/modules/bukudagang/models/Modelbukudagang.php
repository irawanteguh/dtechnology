            ...
            foreach ($bulanList as $index => $bulan) {
                ...
                $penerimaan .= "
                    CASE
                        ...
                        WHEN a.buku_id = '36547c63-46d8-11f0-8318-0894effd6cc3' THEN COALESCE((SELECT SUM(nominal) FROM dt01_keu_piutang_it WHERE piutang_id IN (SELECT piutang_id FROM dt01_keu_piutang_hd WHERE jenis_id = '3' AND periode = '{$periode}')), 0)
                        WHEN a.buku_id = '36547cd1-46d8-11f0-8318-0894effd6cc3' THEN COALESCE((SELECT SUM(nominal) FROM dt01_keu_piutang_it WHERE piutang_id IN (SELECT piutang_id FROM dt01_keu_piutang_hd WHERE jenis_id = '4' AND periode = '{$periode}')), 0)
                        WHEN a.buku_id = '36547d87-46d8-11f0-8318-0894effd6cc3' THEN COALESCE((SELECT SUM(nominal) FROM dt01_keu_piutang_it WHERE piutang_id IN (SELECT piutang_id FROM dt01_keu_piutang_hd WHERE jenis_id = '5' AND periode = '{$periode}')), 0)
                        WHEN a.buku_id = '36547ad1-46d8-11f0-8318-0894effd6cc3' THEN COALESCE((SELECT SUM(nominal) FROM dt01_keu_piutang_it WHERE piutang_id IN (SELECT piutang_id FROM dt01_keu_piutang_hd WHERE jenis_id IN ('1','7') AND rekanan_id = 'daf5e80d-fdb6-48a9-9712-ab253091dcdb' AND periode = '{$periode}')), 0)
                        WHEN a.buku_id = '36547b3e-46d8-11f0-8318-0894effd6cc3' THEN COALESCE((SELECT SUM(nominal) FROM dt01_keu_piutang_it WHERE piutang_id IN (SELECT piutang_id FROM dt01_keu_piutang_hd WHERE jenis_id IN ('1','7') AND rekanan_id = '10217fa6-f8d6-4495-940e-17bad5f4c61e' AND periode = '{$periode}')), 0)
                        WHEN a.buku_id = '36547a64-46d8-11f0-8318-0894effd6cc3' THEN COALESCE((SELECT SUM(nominal) FROM dt01_keu_piutang_it WHERE piutang_id IN (SELECT piutang_id FROM dt01_keu_piutang_hd WHERE jenis_id IN ('1','7') AND rekanan_id NOT IN ('10217fa6-f8d6-4495-940e-17bad5f4c61e','daf5e80d-fdb6-48a9-9712-ab253091dcdb') AND periode = '{$periode}')), 0)
                        ELSE 0
                    END AS {$colPen},";
            }
