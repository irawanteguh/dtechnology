            ...
            $html .= '<div class="tab-pane fade ' . $active . '" id="tabbln' . $bulanKe . '">';
                $html .= '<div class="row">';
                    $html .= '<div class="col-xl-6">';
                            ...
                            $html .= '<div class="card-body p-2">';
                                $html .= '<div class="table-responsive">';
                                    $html .= '<table class="table align-middle table-row-dashed fs-8 gy-2">';
                                        $html .= '<thead>';
                                            $html .= '<tr class="fw-bolder align-middle bg-success text-white">';
                                                $html .= '<th class="ps-4 rounded-start">Pendapatan</th>';
                                                $html .= '<th class="text-end">Estimasi</th>';
                                                $html .= '<th class="text-end">Penerimaan</th>';
                        ...
                        $html .= '<div class="card card-flush mt-3">';
                            $html .= '<div class="card-body p-2">';
                                $html .= '<div class="table-responsive">';
                                    $html .= '<table class="table align-middle table-row-dashed fs-8 gy-2">';
                                        $html .= '<thead>';
                                            $html .= '<tr class="fw-bolder align-middle bg-info text-white">';
                                                $html .= '<th class="ps-4 rounded-start">Persediaan</th>';
                                                $html .= '<th class="text-end">Persediaan Awal</th>';
                                                $html .= '<th class="text-end">Pembeliaan Bulan Ini</th>';
                                                $html .= '<th class="text-end">Pemakaian Bulan Ini</th>';
                                                $html .= '<th class="pe-4 rounded-end text-end">Persediaan Akhir</th>';
                                            $html .= '</tr>';
                                        $html .= '</thead>';
                                    ...
                                    $html .= '<table class="table align-middle table-row-dashed fs-8 gy-2">';
                                        $html .= '<thead>';
                                            $html .= '<tr class="fw-bolder align-middle bg-danger text-white">';
                                                ...
                                                $html .= '<th class="text-end">Estimasi</th>';
                                                $html .= '<th class="text-end">Dibayarkan</th>';
                                                $html .= '<th class="pe-4 rounded-end text-end">Sisa Tagihan</th>';
                                            $html .= '</tr>';
                                        $html .= '</thead>';
