    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/tilakaV2/registrasi/edituser" id="formedituser">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 mb-5">
                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                ...
                                <i class="fas fa-exclamation-circle ms-2 fs-7" data-bs-toggle="tooltip" title="Silakan Upload KTP"></i>
                            </label>
                            <input type="file" class="form-control" name="ktp-edit" id="ktp-edit" accept=".jpeg">
                        </div>
                        <!-- <div class="form-group col-md-12">
                            <label class="col-form-label" for="filektp">Upload KTP</label>
                ...
                <div class="modal-footer p-1">	
                    <input class="btn btn-light-primary" id="btnproses" type="submit" value="UPDATE" name="simpan" >			
                </div>  
            </form>  
        </div>
    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/tte/registrasi/registrasiuser" id="formregisteruser">
                <input type="text" id="userid-registrasi" name="userid-registrasi">
                <div class="modal-body">
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-11">
                            ...
                            <ol class="text-xs" style="text-align: justify;">
                                ...
                                <li>Anda dengan ini menjamin bahwa segala informasi dan/atau Data Pribadi  yang disampaikan kepada TILAKA sehubungan dengan kegiatan Mengakses Layanan TILAKA adalah benar, jelas, akurat dan lengkap. Anda berkewajiban untuk menginformasikan kepada PSrE TILAKA dalam hal terdapat perubahan, penambahan, atau pembaruan atas informasi dan/atau Data Pribadi. PSrE TILAKA berhak untuk menolak permohonan penerbitan Sertifikat Pemilik, menolak permohonan penerbitan ulang Sertifikat Pemilik, menolak permohonan penggantian kunci Sertifikat Pemilik,  dan/atau menolak melakukan perubahan, penambahan, atau pembaruan atas informasi dan/atau Data Pribadi yang tersimpan pada Layanan TILAKA, jika ditemukan atau patut diduga bahwa informasi dan/atau Data Pribadi yang diberikan oleh Anda tidak sesuai dengan ketentuan S&K ini dan Dokumen Publik sebagaimana disebutkan dalam S&K ini.</li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <ul>
                                        <li>Penggantian kunci Sertifikat Pemilik mengakibatkan PSrE TILAKA akan melakukan penerbitan Sertifikat Pemilik baru dengan kunci publik, serial number, dan key identifier yang baru, sementara informasi pribadi Pemilik yang tercantum pada Sertifikat Pemilik yang digunakan untuk menandatangani permohonan penggantian kunci Sertifikat Pemilik baru ini akan tetap digunakan pada Sertifikat Pemilik baru yang akan diterbitkan PSrE TILAKA tersebut;</li>
                                        <li>Penggantian kunci Sertifikat Pemilik mengakibatkan PSrE TILAKA akan membangkitkan pasangan kunci baru yang terasosiasi dengan Sertifikat Pemilik yang digunakan untuk menandatangani permohonan penggantian kunci Sertifikat Pemilik baru ini; dan/atau</li>
                                        <li>Masa berlaku Sertifikat Pemilik baru akan berbeda dengan Sertifikat Pemilik yang Anda gunakan untuk menandatangani permohonan penggantian kunci Sertifikat Pemilik baru ini.</li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>Melakukan tindakan yang disebabkan oleh kelalaian atau kesengajaan olehnya, yang pada pokoknya merusak, menghilangkan, menyembunyikan, menyebabkan perubahan, penambahan, pengurangan, dan/atau membuat tidak dapat digunakannya Layanan TILAKA baik sebagian maupun seluruhnya;</li>
                                        <li>Melakukan tindakan yang baik dengan sengaja atau karena kelalaiannya menyebabkan pelanggaran atas hak PSrE TILAKA dalam hal yang termasuk namun tidak terbatas pada pelanggaran privasi, hak cipta, merek, paten, rahasia dagang, atau hak kekayaan intelektual lainnya, hak yang timbul dari hubungan kontraktual antara PSrE TILAKA dengan pihak ketiga lainnya, dan/atau hak lain yang dimiliki PSrE TILAKA baik untuk masa sekarang maupun di kemudian hari yang dilindungi oleh peraturan perundang-undafngan yang berlaku; dan</li>
                                ...
                                <li>Dalam hal Anda menggunakan Layanan TILAKA melalui aplikasi yang dibuat, dikelola, dikembangkan, atau dimiliki oleh Mitra Bisnis (“aplikasi mitra bisnis”), maka Anda harus mengetahui dan menyetujui bahwa Kami tidak memiliki kendali apapun terhadap konten-konten yang terdapat pada aplikasi tersebut sebelum Anda memilih untuk menggunakan Layanan TILAKA. Akses atau penggunaan Anda terhadap aplikasi mitra bisnis sebelum menggunakan Layanan TILAKA tersebut tunduk pada syarat dan ketentuan serta kebijakan privasi yang ditentukan oleh Mitra Bisnis.</li>
                                <li>Dalam hal Anda menggunakan Layanan TILAKA melalui aplikasi mitra bisnis, Anda dengan ini mengetahui dan setuju bahwa:
                                    <ul>
                                        <li>Mitra Bisnis dapat menyimpan hasil unggahan Dokumen Elektronik berupa Kartu Tanda Penduduk (“KTP”) yang Anda gunakan dalam rangka melakukan Permohonan Penerbitan Sertifikat Pemilik; dan</li>
                                        <li>Untuk kebutuhan pencatatan log internal terhadap Permohonan Penerbitan Sertifikat Pemilik yang Anda lakukan, Mitra Bisnis dapat menyimpan informasi nomor induk kependudukan (“NIK”) yang Anda berikan.</li>
                                    </ul>
                                </li>
                                <li>Dalam hal Anda menggunakan Layanan TILAKA melalui aplikasi mitra bisnis, Anda dengan ini melepaskan tanggung jawab Kami terhadap segala tindakan yang dilakukan oleh Mitra Bisnis terhadap isi atau bagian apapun dari aplikasi mitra bisnis tersebut termasuk bagaimana aplikasi mitra bisnis tersebut memperoleh, mengumpulkan, mengolah, menyimpan, menampilkan, mengumumkan, mengirimkan, dan memusnahkan Data Pribadi Anda sebelum, saat, dan setelah Anda menggunakan Layanan TILAKA.</li>
...
<div class="modal fade" id="modal-reenroll" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header pb-0">
                <h1 class="mb-3">Reenroll User Tilaka</h1>
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
                    <span class="svg-icon svg-icon-1">
                        <i class="bi bi-x-lg"></i>
                    </span>
