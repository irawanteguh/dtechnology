<div class="modal fade" id="modal_sign_add" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>index.php/bsre/repodocument/signdocument" id="formsigndocument">
                ...
                <div class="modal-footer p-1">				
                    <input class="btn btn-light-primary" id="modal_sign_add_btn" type="submit" value="SAVE" name="simpan" >
                </div>
            </form>
        </div>
    </div>
