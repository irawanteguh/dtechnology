...
<?php if ($leveluser === "83e9982c-814a-4349-89fb-cbee6f34e340"): ?>
    ...
    <?php if ($xidb && $xids && $xide): ?>
        <!-- Kondisi 4: Upload Document -->
        <a class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#modal_upload_document">
            <i class="bi bi-cloud-arrow-up me-4"></i>Upload Document
        </a>
