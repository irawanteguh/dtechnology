        ...
        <div class="card rounded bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: #663259;background-size: auto 100%; background-image: url('<?php echo base_url();?>assets/images/svg/misc/taieri.svg')">
            <div class="card-body pt-9 pb-0">
                <div class="d-flex flex-wrap flex-sm-nowrap mb-5">
                    <div>
                        <h1 class="text-white">Laporan Piutang Asuransi</h1>
                        <p class="text-white mb-0">
                            Menyajikan data piutang Asuransi secara real-time untuk evaluasi finansial dan peningkatan pelayanan rumah sakit.
                        </p>
                    </div>
                </div>
        ...
        <div class="tab-content p-0">
                ...
                <div class="card card-flush">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Laporan Piutang Asuransi</span>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a data-bs-toggle="modal" data-bs-target="#modal_mcu_invoice" class="menu-link px-3">Invoice Rawat Jalan</a>
                                    <a data-bs-toggle="modal" data-bs-target="#modal_mcu_invoice_ri" class="menu-link px-3">Invoice Rawat Inap</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="tabhistory" class="card-body p-0 tab-pane fade" role="tabpanel" aria-labelledby="tab_month">
                <div class="card card-flush">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">Laporan Pembayaran Asuransi</span>
                            <span class="text-muted mt-1 fw-bold fs-7" id="info_list_document"></span>
                        </h3>
                    </div>
                    <div class="card-body">
