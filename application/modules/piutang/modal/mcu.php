...
<div class="modal fade" id="modal_history_payment" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header pb-0 border-0 justify-content-end">
                <div class="btn btn-sm btn-icon btn-active-color-primary" data-bs-dismiss="modal">
            ...
            <div class="modal-body">
                <div class="text-center mb-5">
                    <h1 class="mb-3">History Payment</h1>
                    <div class="text-muted fw-bold fs-5"></div>
                </div>
                <div class="row">
                        ...
                        <table class="table align-middle table-row-dashed fs-8 gy-2">
                            <thead>
                                <tr class="fw-bolder text-muted align-middle bg-light">
                                    ...
                                    <th>Catatan</th>
                                    <th>Nominal</th>
                                    <th class="pe-4 text-end">Dibuat Oleh</th>
                                </tr>
                            </thead>
                            <tbody class="text-gray-600 fw-bold" id="resultdatahistorypayment"></tbody>
                        </table>
                    </div>
                </div>
            </div>
