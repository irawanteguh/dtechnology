<?php
    function renderHospitalCard($nama, $bg, $idprefix, $totalid, $cardlabel) {
        ...
        ?>
        <div class="col-6 col-sm-6 col-lg-3 animate__animated animate__fadeIn">
            ...
            <div class="card-header card-header-stretch">
                ...
                <div class="card-toolbar m-0">
                    <ul class="nav nav-tabs nav-line-tabs nav-stretch fs-6 border-0 fw-bolder" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <a id="tab_month" class="nav-link justify-content-center text-active-gray-800" data-bs-toggle="tab" role="tab" href="#tabmonth">Last 30 Days</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a id="tab_years" class="nav-link justify-content-center text-active-gray-800" data-bs-toggle="tab" role="tab" href="#tabyears">This Years</a>
                        </li>
                    </ul>
                </div>
            </div>
