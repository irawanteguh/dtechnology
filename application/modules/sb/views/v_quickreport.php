    ...
    <div class="card-body pt-9 pb-0">
        ...
        <div class="d-flex overflow-auto h-55px">
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#tabbln01">Januari</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#tabbln02">Febuari</a>
                </li>
                <li class="nav-item">
...
<div class="row gy-5 g-xl-8 mb-xl-8">
    <div class="tab-content">
        <div class="tab-pane fade" id="tabbln01" role="tabpanel">
        ...
        <div class="tab-pane fade show active" id="tabbln02" role="tabpanel">
            <div class="row mb-5">
                <div class="col-xl-3">
                    <div class="card card-flush h-100">
