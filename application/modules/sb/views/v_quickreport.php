    ...
    <div class="card rounded bgi-no-repeat bgi-position-x-end bgi-size-cover" style="background-color: #663259;background-size: auto 100%; background-image: url('<?php echo base_url();?>assets/images/svg/misc/taieri.svg')">
        <div class="card-body pt-9 pb-0">
            <div class="d-flex flex-wrap flex-sm-nowrap mb-5">
                <div>
                    <h1 class="text-white">Quick Report</h1>
                    <p class="text-white mb-0">
                        Laporan ringkas yang menyajikan data terkini untuk mendukung analisis cepat dan pengambilan keputusan strategis di lingkungan rumah sakit RMB Group.
                    </p>
                </div>
            </div>
            <div class="d-flex overflow-auto h-55px">
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap">
                    ...
                    foreach ($bulan as $index => $namaBulan) {
                        $active = ($index + 1 == $bulanSekarang) ? 'text-white active border-white' : ' text-warning';
                                                        ...
                                                        <div class="d-flex align-items-center mb-2">
                                                            ...
                                                            <div class="d-flex align-items-center flex-wrap w-100">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div class="fw-bolder fs-7 text-gray-800 pe-1" id="<?php echo $item['id'] . $kode; ?>">NaN</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; ?>
