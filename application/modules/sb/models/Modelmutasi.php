<?php
    class Modelmutasi extends CI_Model{
        ...
        function datamutasi($rekeningid,$parameter){
            $query =
                    "
                        select a.org_id, transaksi_id, no_kwitansi, note, cash_in, cash_out, balance, status, date_format(a.created_date, '%d.%m.%Y %H:%i:%s')tglbuat,
