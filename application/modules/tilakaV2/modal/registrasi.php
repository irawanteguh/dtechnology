                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-11">
                            ...
                            <ol class="text-xs" style="text-align: justify;">
                                ...
                                <li>Dalam hal Anda menggunakan Layanan TILAKA melalui aplikasi yang dibuat, dikelola, dikembangkan, atau dimiliki oleh Mitra Bisnis (“aplikasi pihak ketiga”), maka Anda harus mengetahui dan menyetujui bahwa Kami tidak memiliki kendali apapun terhadap konten-konten yang terdapat pada aplikasi tersebut sebelum Anda memilih untuk menggunakan Layanan TILAKA. Akses atau penggunaan Anda terhadap aplikasi <b><?php $_SESSION['hospitalname']?></b> sebelum menggunakan Layanan TILAKA tersebut tunduk pada syarat dan ketentuan serta kebijakan privasi yang ditentukan oleh <b><?php $_SESSION['hospitalname']?></b>.</li>
                                <li>Dalam hal Anda menggunakan Layanan TILAKA melalui aplikasi pihak ketiga, Anda dengan ini mengetahui dan setuju bahwa:
                                    <ul>
                                        <li>Mitra Bisnis tidak menyimpan hasil unggahan Dokumen Elektronik berupa Kartu Tanda Penduduk (“KTP”) yang Anda gunakan dalam rangka melakukan Permohonan Penerbitan Sertifikat Pemilik; dan</li>
                                        <li>Untuk kebutuhan pencatatan log internal terhadap Permohonan Penerbitan Sertifikat Pemilik yang Anda lakukan, Mitra Bisnis akan menyimpan informasi nomor induk kependudukan (“NIK”) yang Anda berikan.</li>
                                    </ul>
                                </li>
                                <li>Anda dengan ini melepaskan tanggung jawab Kami terhadap segala tindakan yang dilakukan oleh Mitra Bisnis terhadap isi atau bagian apapun dari aplikasi pihak ketiga tersebut termasuk bagaimana aplikasi pihak ketiga tersebut memperoleh, mengumpulkan, mengolah, menyimpan, menampilkan, mengumumkan, mengirimkan, dan memusnahkan Data Pribadi Anda sebelum, saat, dan setelah Anda menggunakan Layanan TILAKA.</li>
