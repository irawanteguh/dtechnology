...
<div class="row gy-5 g-xl-8 mb-xl-8">
    <form id="uploadForm" enctype="multipart/form-data">
        <div class="mb-3">
            <label for="txt_file" class="form-label fw-bold">Upload File Aspak Alat Kesehatan</label>
    ...
    <div class="card card card-flush h-100">
        <div class="card-header">
            <div class="card-title d-flex align-items-center">
                <h6 class="fw-bolder m-0 text-gray-800">Preview upload Aspak Alat Kesehatan</h3>
            </div>
        </div>
        <div class="card-body">
            <div class="col-xl-12">
