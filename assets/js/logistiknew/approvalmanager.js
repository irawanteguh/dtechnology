            ...
            if(data.responCode==="00"){
                ...
                let rows  ="<tr>";
                        ...
                        rows +="<div class='btn-group' role='group'>";
                            ...
                            if(result[i].methodid==="4"){
                                ...
                                if(result[i].status==="4"){
                                    rows +="<a class='dropdown-item btn btn-sm text-info' "+getvariabel+" datastatus='19' datavalidator='MANAGER' onclick='validasi($(this));'><i class='bi bi-arrow-counterclockwise text-info'></i> Cancel Approved</a>";
                                }
                            }

                            if(result[i].methodid==="6" || result[i].methodid==="7" || result[i].methodid==="9" || result[i].methodid==="10" || result[i].methodid==="11" || result[i].methodid==="12" || result[i].methodid==="13"){
                    ...
                    if(result[i].status === "2" || result[i].status === "19"){
                        ...
                        if(result[i].status === "3" || result[i].status === "5" || result[i].status === "20" || result[i].status === "26" || result[i].status === "28" || result[i].status === "30"){
                            resultdatadecline += rows;
                        }else{
                            if(result[i].status === "4" || result[i].status === "6" || result[i].status === "21" || result[i].status === "27" || result[i].status === "29" || result[i].status === "31"){
