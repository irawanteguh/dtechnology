                                ...
                                if(result[i].status==="29"){
                                    if(result[i].methodid==="5"){
                                        ...
                                        if(result[i].methodid==="8"){
                                            rows +="<a class='dropdown-item btn btn-sm text-info' "+getvariabel+" datastatus='25' datavalidator='CFO' onclick='validasi($(this));'><i class='bi bi-arrow-counterclockwise text-info'></i> Cancel Approved</a>";
                                        }else{
