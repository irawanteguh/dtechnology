                        ...
                        rows +="<div class='btn-group' role='group'>";
                            ...
                            if(result[i].methodid==="11"){
                                ...
                                if(result[i].status==="29"){
                                    rows +="<a class='dropdown-item btn btn-sm text-danger' "+getvariabel+" datastatus='21' datavalidator='CFO' onclick='validasi($(this));'><i class='bi bi-trash-fill text-danger'></i> Cancel Approved</a>";
                                }
                            }
