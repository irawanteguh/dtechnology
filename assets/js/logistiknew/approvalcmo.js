...
$("#modal_master_detail_spu").on('shown.bs.modal', function(event){
    ...
    detailbarangspu(datanopemesanan,"CMO");
});
...
function datapemesanan(startDate,endDate){
    ...
    $.ajax({
        url       : url+"index.php/logistiknew/approvalcmo/datapemesanan",
                        ...
                        rows +="<div class='btn-group' role='group'>";
                            ...
                            if(result[i].methodid==="5" || result[i].methodid==="7" || result[i].methodid==="8" || result[i].methodid==="9" || result[i].methodid==="10" || result[i].methodid==="11" || result[i].methodid==="12"){
                                ...
                                if(result[i].status==="31"){
                                    rows +="<a class='dropdown-item btn btn-sm text-info' "+getvariabel+" datastatus='29' datavalidator='CMO' onclick='validasi($(this));'><i class='bi bi-arrow-counterclockwise text-info'></i> Cancel Approved</a>";
                                }
                            }
