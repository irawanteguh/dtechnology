...
function certificatestatus(btn){
    ...
    $.ajax({
        url       : url+"index.php/tte/registrasi/certificatestatus",
...
function activequicksign(btn){
    ...
    var registerid     = $(btn).attr("data-registerid");
    $.ajax({
        url       : url+"index.php/tte/registrasi/activequicksign",
        ...
        success:function(data){
            ...
            if(result['success']){
                window.location.href = result['auth_response'][0]['url']+"&redirect_url=" + url + "index.php/tte/registrasi?request_id="+registerid+"&quicksign=Y";
            }else{
                let alertType  = "error";
...
function datakaryawan(){
    ...
    $.ajax({
        url        : url+"index.php/tte/registrasi/datakaryawan",
        data       : {search:search},
        method     : "POST",
        dataType   : "JSON",
        cache      : false,
        ...
        success:function(data){
            ...
            if(data.responCode==="00"){
                ...
                for(var i in result){
                    ...
                    btnverifpengajuan          = "<a class='dropdown-item btn btn-sm' href='"+tilakabaseurl+"personal-webview/guide?request_id="+result[i].REGISTER_ID+"&redirect_url="+url+"index.php/tte/registrasi'><i class='bi bi-person-bounding-box'></i> Liveness</a>";
                    btnappcertificate          = "<a class='dropdown-item btn btn-sm' href='"+tilakabaseurl+"personal-webview/link-account?setting=1&channel_id="+clientidtilaka+"&request_id="+result[i].REGISTER_ID+"&redirect_url="+url+"index.php/tte/registrasi'><i class='bi bi-shield-check'></i> Activation</a>";
                    btnappcertificatereenrolll = "<a class='dropdown-item btn btn-sm' href='"+tilakabaseurl+"personal-webview/link-account?setting=1&channel_id="+clientidtilaka+"&issue_id="+result[i].ISSUE_ID+"&redirect_url="+url+"index.php/tte/registrasi'><i class='bi bi-shield-check'></i> Activation Re Enroll</a>";
                    btnapprevoke               = "<a class='dropdown-item btn btn-sm' href='"+tilakabaseurl+"personal-webview/kyc/revoke?revoke_id="+result[i].REVOKE_ID+"&redirect_url="+url+"index.php/tte/registrasi' title='Revoke Approval'><i class='bi bi-person-bounding-box'></i> Liveness</a>";
...
$(document).on("submit", "#formedituser", function (e) {
	...
	$.ajax({
        url        : url+'index.php/tte/registrasi/edituser',
        data       : data,
        method     : "POST",
        dataType   : "JSON",
        cache      : false,
...
$(document).on("submit", "#formadduser", function (e) {
	...
	var data = new  FormData(this);
	$.ajax({
        url        : url+'index.php/tte/registrasi/adduser',
        data       : data,
        method     : "POST",
        dataType   : "JSON",
        cache      : false,
...
$(document).on("submit", "#formregisteruser", function (e) {
	...
	var data = new  FormData(this);
	$.ajax({
        url        : url+'index.php/tte/registrasi/registrasiuser',
        data       : data,
        method     : "POST",
        dataType   : "JSON",
        cache      : false,
		...
		success: function (data) {
			if(data.responCode==="00"){
                var result = data.responResult;
                if(result['success']){
                    window.location.href = tilakabaseurl + "personal-webview/guide?request_id="+result['data'][0]+"&redirect_url=" + url + "index.php/tte/registrasi";
                }else{
                    Swal.fire({
...
$(document).on("submit", "#formrevoke", function (e) {
	...
	var data = new  FormData(this);
	$.ajax({
        url        : url+'index.php/tte/registrasi/revoke',
        data       : data,
        method     : "POST",
        dataType   : "JSON",
        cache      : false,
		...
		success: function (data) {
            var result        = data.responResult;
            if(result['success']){
                window.location.href = tilakabaseurl+"personal-webview/kyc/revoke?revoke_id="+result['data'][0]+"&redirect_url="+url+"index.php/tte/registrasi";
            }else{
                Swal.fire({
                    title            : "<h1 class='font-weight-bold' style='color:#234974;'>For Your Information</h1>",
...
$(document).on("submit", "#formreenroll", function (e) {
	...
	var data = new  FormData(this);
	$.ajax({
        url        : url+'index.php/tte/registrasi/reenroll',
        data       : data,
        method     : "POST",
        dataType   : "JSON",
        cache      : false,
		...
		success: function (data) {
            ...
            if(data.responCode === "00"){
                if(result['success']){
                    window.location.href = tilakabaseurl+"personal-webview/kyc/re-enroll?issue_id="+result['data'][0]+"&redirect_url="+url+"index.php/tte/registrasi";
                }else{
                    Swal.fire({
                        title            : "<h1 class='font-weight-bold' style='color:#234974;'>For Your Information</h1>",
                        html             : "<b>"+result['message']+"</b>",
