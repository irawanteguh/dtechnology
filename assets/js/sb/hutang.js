...
function dataharian() {
    ...
    $.ajax({
        url       : url + "index.php/sb/hutang/dataharian",
        ...
        beforeSend: function () {
            ...
            for (let i = 1; i <= 12; i++) {
                let key = i < 10 ? i : '' + i;
                $("#resulthutangtabblnrsms" + key).html("");
                $("#resulthutangtabblnrsia" + key).html("");
                $("#resulthutangtabblnrst" + key).html("");
                $("#resulthutangtabblnrmb" + key).html("");
            }
        },
        success: function(data){
            ...
            if(data.responCode === "00"){
                ...
                for (let i in result) {
                    ...
                    $("#resulthutangtabbln" + rsCode + keyMonth).append(htmlRS);
                ...
                for (let m = 1; m <= 12; m++) {
                    ...
                    if (groupRMB[key]) {
                        ...
                        $("#resulthutangtfoottabblnrmb" + key).html(rows.join(""));
                    }
                }
                ...
                for (let m = 1; m <= 12; m++) {
                    ...
                    for (let rsCode of ["rsms", "rsia", "rst"]) {
                        if (groupPerRS[rsCode][key]) {
                            ...
                            $("#resulthutangtfoottabbln" + rsCode + key).html(tfoot);
                        }
                    }
                }
            }
