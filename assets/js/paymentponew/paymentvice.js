...
//     $.ajax({
//         url       : url+"index.php/paymentponew/paymentvice/dataonprocess",
//         method    : "POST",
//         dataType  : "JSON",
//         cache     : false,
//         beforeSend: function () {
...
//                     tableresult +="<td><div>"+result[i].namainvmanager+"<div>"+result[i].tglinvmanager+"</div></td>";
//                     tableresult += "<td class='text-end'>";
//                         tableresult +="<div class='btn-group' role='group'>";
//                             tableresult +="<button id='btnGroupDrop1' type='button' class='btn btn-light-primary dropdown-toggle btn-sm' data-bs-toggle='dropdown' aria-expanded='false'>Action</button>";
//                             tableresult +="<div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>";
//                             tableresult +="<a class='dropdown-item btn btn-sm text-success' "+getvariabel+" datastatus='11' datavalidator='VICE' onclick='validasi($(this));'><i class='bi bi-check2-circle text-success'></i> Invoice Approved</a>";
//                             tableresult +="<a class='dropdown-item btn btn-sm text-danger' "+getvariabel+" datastatus='10' datavalidator='VICE' onclick='validasi($(this));'><i class='bi bi-trash-fill text-danger'></i> Invoice Decline</a>";
...
//     $.ajax({
//         url       : url+"index.php/paymentponew/paymentvice/dataapprove",
...
//     $.ajax({
//         url       : url+"index.php/paymentponew/paymentvice/datadecline",
//         method    : "POST",
//         dataType  : "JSON",
//         cache     : false,
//         beforeSend: function () {
...
//             $.ajax({
//                 url       : url+"index.php/paymentponew/paymentvice/updateheader",
...
function datapemesanan(){
    $.ajax({
        url       : url+"index.php/paymentponew/paymentvice/datapemesanan",
        method    : "POST",
        dataType  : "JSON",
        cache     : false,
        beforeSend: function () {
            ...
            if(data.responCode==="00"){
                ...
                let rows  ="<tr>";
                    ...
                    rows += "<td class='text-end'>";
                        rows +="<div class='btn-group' role='group'>";
                            ...
                            if(result[i].status==="9"){
                                rows +="<a class='dropdown-item btn btn-sm text-success' "+getvariabel+" datastatus='11' datavalidator='VICE_INV' onclick='validasi($(this));'><i class='bi bi-check2-circle text-success'></i> Invoice Approved</a>";
                                rows +="<a class='dropdown-item btn btn-sm text-danger' "+getvariabel+" datastatus='10' datavalidator='VICE_INV' onclick='validasi($(this));'><i class='bi bi-trash-fill text-danger'></i> Invoice Decline</a>";
                            }
                    ...
                    if(result[i].status === "9"){
                        ...
                        if(result[i].status === "10" || result[i].status === "12"){
                            resultdatadecline += rows;
                        }else{
                            if(result[i].status === "11" || result[i].status === "13"){
